...
describe('tests', () => {
    it('not parsable', () => {
        const r = new _1.default('http://www.dingo.com/search/tearm?asg=123123&g=asdasd');
    ...
    it('test_google_minimal', () => {
        const r = new _1.default('http://www.google.com/search');
        expect(r.known).toBe(true);
    ...
    it('test_google_term', () => {
        const r = new _1.default('http://www.google.com/search?q=gateway+oracle+cards+denise+linn&hl=en&client=safari');
        expect(r.known).toBe(true);
        expect(r.referer).toEqual('Google');
    ...
    it('test_powered_by_google', () => {
        const r = new _1.default('http://isearch.avg.com/pages/images.aspx?q=tarot+card+change&sap=\
    ...
    it('test_google_img_search', () => {
        const r = new _1.default('http://www.google.fr/imgres?q=Ogham+the+celtic+oracle&hl=fr&safe=\
    ...
    it('test_yahoo_search', () => {
        const r = new _1.default('http://es.search.yahoo.com/search;_ylt=A7x9QbwbZXxQ9EMAPCKT.Qt.?p=' +
    ...
    it('test_yahoo_img_search', () => {
        const r = new _1.default('http://it.images.search.yahoo.com/images/view;_ylt=A0PDodgQmGBQpn\
    ...
    it('test_price_runner_search', () => {
        const r = new _1.default('http://www.pricerunner.co.uk/search?displayNoHitsMessage=1&q=wild+wisdom+of+the+faery+oracle');
        expect(r.known).toBe(true);
    ...
    it('test_bing_img', () => {
        const r = new _1.default('http://www.bing.com/images/search?q=psychic+oracle+cards&view=det\
    ...
    it('test_ixquick', () => {
        const r = new _1.default('https://s3-us3.ixquick.com/do/search');
        expect(r.known).toBe(true);
    ...
    it('test_aol_search', () => {
        const r = new _1.default('http://aolsearch.aol.co.uk/aol/search?s_chn=hp&enabled_terms=&s_i\
    ...
    it('test_ask_search', () => {
        const r = new _1.default('http://uk.search-results.com/web?qsrc=1&o=1921&l=dis&q=pendulums&\
    ...
    it('test_mailru_search', () => {
        const r = new _1.default('http://go.mail.ru/search?q=Gothic%20Tarot%20Cards&where=any&num=1\
    0&rch=e&sf=20');
        expect(r.known).toBe(true);
    ...
    it('test_yandex_search', () => {
        const r = new _1.default('http://images.yandex.ru/yandsearch?text=Blue%20Angel%20Oracle%20B' +
    ...
    it('test_twitter_redirect', () => {
        const r = new _1.default('http://t.co/chrgFZDb');
        expect(r.known).toBe(true);
    ...
    it('test_fb_social', () => {
        const r = new _1.default('http://www.facebook.com/l.php?u=http%3A%2F%2Fwww.psychicbazaar.co\
    m&h=yAQHZtXxS&s=1');
        expect(r.known).toBe(true);
    ...
    it('test_fb_mobile', () => {
        const r = new _1.default('http://m.facebook.com/l.php?u=http%3A%2F%2Fwww.psychicbazaar.com%\
    ...
    it('test_odnoklassniki', () => {
        const r = new _1.default('http://www.odnoklassniki.ru/dk?cmd=logExternal&st._aid=Conversati\
    ...
    it('test_tumblr', () => {
        const r = new _1.default('http://www.tumblr.com/dashboard');
        expect(r.known).toBe(true);
    ...
    it('test_tumblr_subdomain', () => {
        const r = new _1.default('http://psychicbazaar.tumblr.com/');
        expect(r.known).toBe(true);
        expect(r.referer).toEqual('Tumblr');
        expect(r.searchTerm).toEqual(null);
        expect(r.medium).toEqual('social');
    ...
    it('test_yahoo_mail', () => {
        const r = new _1.default('http://36ohk6dgmcd1n-c.c.yom.mail.yahoo.net/om/api/1.0/openmail.a\
    ...
    it('test_outlookcom_mail', () => {
        const r = new _1.default('http://co106w.col106.mail.live.com/default.aspx?rru=inbox');
        expect(r.known).toBe(true);
    ...
    it('test_orange_webmail', () => {
        const r = new _1.default('http://webmail1m.orange.fr/webmail/fr_FR/read.html?FOLDER=SF_INBO\
X&IDMSG=8594&check=&SORTBY=31');
    ...
    it('Adform', () => {
        const r = new _1.default('http://adform.net/read.html?FOLDER=SF_INBO\
X&IDMSG=8594&check=&SORTBY=31');
        expect(r.known).toBe(true);
    ...
    it('test_internal', () => {
        const r = new _1.default('http://www.snowplowanalytics.com/about/team', 'http://www.snowplowanalytics.com/account/profile');
        expect(r.known).toBe(true);
